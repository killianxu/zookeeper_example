...
import cn.killianxu.election.LeaderElectionSupport.EventType;
...
public class LeaderElectionSupportTest  {
  ...
  protected ZooKeeper createClient() throws IOException {
        ...
        ZooKeeper zk = new ZooKeeper(connStr,60,null);
        return zk;
  }
  @After
  ...
  public void testReadyOffer() throws Exception {
      ...
      electedComplete.await(60 / 3, TimeUnit.MILLISECONDS);
